...
def to_mod_list(employee_list):
   ...
   lists = list(map(mod, employee_list))
...
def map_id_to_initial(employee_list):
   ...
   for i in employee_list:
      employee_name.append(i['name'][0])
      employee_id.append(i['id'])

   dicts = {employee_name: employee_id for (employee_name, employee_id) in zip(employee_name, employee_id)}
